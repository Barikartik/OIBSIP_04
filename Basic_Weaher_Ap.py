...
def weather_app(api_key, city, temperature_selection):
    try:
        base_url ="https://www.bing.com/search?q=weather+api&gs_lcrp=EgZjaHJvbWUqBwgAEEUYwgMyBwgAEEUYwgMyBwgBEEUYwgMyBwgCEEUYwgMyBwgDEEUYwgPSAQk3MTg4OWowajGoAgSwAgE&FORM=ANNTA1&PC=WSEDDB"
